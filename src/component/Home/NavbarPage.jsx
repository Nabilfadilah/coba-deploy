...
function NavbarPage() {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg shadow fixed-top" style={{ fontSize: "18px", 
                ...
                <div className="container" style={{ height: "84px" }}>
                    ...
                    <div className="collapse navbar-collapse justify-content-end round" id="navbarNavDropdown">
